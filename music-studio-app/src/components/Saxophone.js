...
const styles = StyleSheet.create({
    ...
    ornamentLine: { width: sc(140), height: sc(1.5), backgroundColor: 'rgba(0,0,0,0.1)', opacity: 0.3 },
    ...
    keyCup: {
        ...
        justifyContent: 'center',
        alignItems: 'center',
        ...createShadow({ color: '#000', radius: sc(15), offsetY: sc(10) }),
    },
    pearlInlay: { width: '85%', height: '85%', borderRadius: sc(55), overflow: 'hidden', borderWidth: sc(1.5), borderColor: 'rgba(0,0,0,0.1)' },
    ...
    reedPulse: { backgroundColor: 'rgba(255,255,255,0.04)', paddingHorizontal: sc(30), paddingVertical: sc(10), borderRadius: sc(25), borderWidth: sc(1), borderColor: 'rgba(255,255,255,0.1)' },
